...
export const steps = [
  {
    ...
    description:"First, choose the image you want to remove the background from by clicking on 'Start from a photo'. Your image format can be PNG or JPG. We support all image dimensions."
...
export const testimonials = [
    ...
    {
        id: 3,
        quote: "We were impressed by its ability to account for pesky, feathery hair without making an image look jogged and amateurish.",
        author: "Michael Chen",
