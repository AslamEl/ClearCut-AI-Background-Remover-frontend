  ...
  <div className="container mx-auto px-4">
    ...
    <div className="mb-12 text-center">
      ...
      <p className="mx-auto mt-4 max-w-2xl text-gray-500">
        Discover flexible packages that suit every need and budget.
        Whether you're using it for fun or work, each plan offers great
        value and useful features. Choose the one that fits you best and get started with ease.
      </p>
    </div>
    ...
    <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
      {plans.map((plan) => (
        ...
        >
          {plan.popular && (
            <div className="absolute -top-4 left-1/2 -translate-x-1/2 rounded-full bg-purple-500 px-3 py-1 text-white text-sm font-semibold">
              Most Popular
            </div>
          )}
          ...
          <div className="px-4 pb-8">
            ...
            <button
              className="w-full py-3 px-6 text-center text-white font-semibold rounded-full
                ...
                hover:from-purple-600 hover:to-indigo-600 transition duration-300 ease-in-out
